# 🎓 Plan de Estudios: Finanzas e Inversiones desde Cero (`imyisusdev`)
...
## 🛠️ Enfoque Pedagógico: Progresión de Carga Cognitiva

Aprender a invertir genera parálisis por análisis debido a la cantidad de términos técnicos. Para resolver esto:
1. **Andamiaje (Scaffolding):** Cada clase es prerrequisito de la siguiente. No abrimos cuenta en un bróker sin antes entender los impuestos y las comisiones.
2. **Analogías cotidianas:** Explicamos conceptos complejos con situaciones de la vida diaria para asentar el conocimiento.
3. **Foco en el "Primer Clic":** El curso termina con una práctica real para romper la barrera del miedo.

---

## 📅 Temario Detallado (5 Clases de 1 Hora)

### 🧹 Clase 1: Del Caos al Ahorro Activo (El Suelo Firme)
...
### 📦 Clase 2: El Menú de Inversiones: Fondos vs. Acciones vs. ETFs
...
### ❄️ Clase 3: La Bola de Nieve y la Latencia de los Impuestos
...
### 🔌 Clase 4: Eligiendo el Bróker Correcto en Perú (La Infraestructura)
...
### 🎯 Clase 5: Taller Práctico: Tu Primera Compra Real
